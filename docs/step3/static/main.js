...
var author$project$AnaQRam$Puzzle$Puzzle = F2(
	function (pieces, answer) {
		return {answer: answer, pieces: pieces};
	});
...
var author$project$AnaQRam$Puzzle$empty = A2(author$project$AnaQRam$Puzzle$Puzzle, elm$core$Array$empty, '');
var author$project$AnaQRam$Puzzle$Piece = F3(
	function (hidden, index, _char) {
		return {_char: _char, hidden: hidden, index: index};
	});
...
var author$project$AnaQRam$Puzzle$init = F2(
	function (answer, puzzle) {
		var pieces = A2(
			elm$core$Array$indexedMap,
			author$project$AnaQRam$Puzzle$Piece(true),
			elm$core$Array$fromList(
				elm$core$String$toList(answer)));
		return _Utils_update(
			puzzle,
			{answer: answer, pieces: pieces});
	});
...
var author$project$AnaQRam$Puzzle$shuffle = F2(
	function (toMsg, puzzle) {
		return A2(
			...
			elm_community$random_extra$Random$Array$shuffle(puzzle.pieces));
	});
var author$project$Main$Model = F4(
	function (config, error, puzzle, click) {
		return {click: click, config: config, error: error, puzzle: puzzle};
	});
var author$project$Main$ShufflePuzzle = function (a) {
	return {$: 'ShufflePuzzle', a: a};
};
var author$project$Main$init = function (config) {
	return _Utils_Tuple2(
		A4(author$project$Main$Model, config, '', author$project$AnaQRam$Puzzle$empty, elm$core$Maybe$Nothing),
		A2(
			author$project$AnaQRam$Puzzle$shuffle,
			author$project$Main$ShufflePuzzle,
			A2(author$project$AnaQRam$Puzzle$init, 'あなくらむ！', author$project$AnaQRam$Puzzle$empty)));
};
...
var author$project$AnaQRam$Puzzle$displayPiece = F2(
	function (idx, piece) {
		return _Utils_eq(piece.index, idx) ? _Utils_update(
			piece,
			{hidden: false}) : piece;
	});
var author$project$AnaQRam$Puzzle$size = function (puzzle) {
	return elm$core$Array$length(puzzle.pieces);
};
...
var author$project$AnaQRam$Puzzle$display = F2(
	function (idx, puzzle) {
		var pIdx = A2(
			elm$core$Basics$modBy,
			author$project$AnaQRam$Puzzle$size(puzzle),
			idx);
		var updated = A2(
			elm$core$Array$map,
			author$project$AnaQRam$Puzzle$displayPiece(pIdx),
			puzzle.pieces);
		return _Utils_update(
			puzzle,
			{pieces: updated});
...
var author$project$AnaQRam$Puzzle$swapPiece = F3(
	function (idxA, idxB, puzzle) {
		var _n0 = _Utils_Tuple2(
			A2(elm$core$Array$get, idxA, puzzle.pieces),
			A2(elm$core$Array$get, idxB, puzzle.pieces));
		if ((_n0.a.$ === 'Just') && (_n0.b.$ === 'Just')) {
			...
			var updated = A3(
				...
				idxA,
				pieceB,
				A3(elm$core$Array$set, idxB, pieceA, puzzle.pieces));
			return _Utils_update(
				puzzle,
				{pieces: updated});
		} else {
		...
		if (_n0.$ === 'Nothing') {
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						click: elm$core$Maybe$Just(idx)
					}),
				elm$core$Platform$Cmd$none);
		} else {
			var oldIdx = _n0.a;
			var updated = A3(author$project$AnaQRam$Puzzle$swapPiece, idx, oldIdx, model.puzzle);
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{click: elm$core$Maybe$Nothing, puzzle: updated}),
				elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
					...
					if (msg.a.a.$ === 'Nothing') {
						...
						var updated = A2(
							...
							A2(
								elm$core$Maybe$map,
								function (idx) {
									return A2(author$project$AnaQRam$Puzzle$display, idx, model.puzzle);
								},
								elm$core$String$toInt(qrcode.data)));
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{error: '', puzzle: updated}),
							elm$core$Platform$Cmd$none);
					}
				} else {
					var message = msg.a.a;
			...
			case 'ClickPiece':
				var idx = msg.a;
				return A2(author$project$Main$updatePiece, idx, model);
			default:
				var puzzle = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var author$project$Main$EnableCamera = {$: 'EnableCamera'};
var author$project$AnaQRam$Puzzle$map = F2(
	function (f, puzzle) {
		return elm$core$Array$toList(
			A2(elm$core$Array$indexedMap, f, puzzle.pieces));
	});
...
var author$project$AnaQRam$Puzzle$pieceToString = function (piece) {
	return piece.hidden ? '？' : elm$core$String$fromChar(piece._char);
};
var author$project$Main$ClickPiece = function (a) {
	return {$: 'ClickPiece', a: a};
};
...
var author$project$Main$viewPiece = F3(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					author$project$Main$ClickPiece(viewIdx))
				]),
			_List_fromArray(
				[
					elm$html$Html$text(
					author$project$AnaQRam$Puzzle$pieceToString(piece))
				]));
	});
...
var author$project$Main$viewPuzzle = function (model) {
	return A2(
		...
		_List_Nil,
		A2(
			author$project$AnaQRam$Puzzle$map,
...
var author$project$AnaQRam$Puzzle$success = function (puzzle) {
	return elm$core$String$isEmpty(puzzle.answer) ? false : _Utils_eq(
		puzzle.answer,
		elm$core$String$concat(
			elm$core$Array$toList(
				A2(elm$core$Array$map, author$project$AnaQRam$Puzzle$pieceToString, puzzle.pieces))));
};
var author$project$Main$viewResult = function (model) {
	var _n0 = _Utils_Tuple2(
		author$project$AnaQRam$Puzzle$success(model.puzzle),
		model.error);
	if (_n0.a) {
		return A2(
			elm$html$Html$p,
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$EnableCamera)
							]),
						_List_fromArray(
							[
								elm$html$Html$text('Enable Camera')
							]))
					])),
				A2(
				elm$html$Html$p,
